#import everithing from tkinter
from tkinter import *
...
button_add = Button(root, text="+", padx=39, pady=92, command=button_add)
button_equal = Button(root, text="=", padx=137, pady=40, command=button_equal)
button_clear = Button(root, text="Clear", padx=80, pady=40, command=button_clear)

button_subtract = Button(root, text="-", padx=41, pady=40, command=button_subtract)
button_multiply = Button(root, text="*", padx=40, pady=40, command=button_multiply)
button_divide = Button(root, text="/", padx=41, pady=40, command=button_divide)

#asigne buttons to a grid
